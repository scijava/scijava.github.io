 ...
 * Created by rleigh via genspec on 2013-01-18 16:59:32.441508
 *
 *─────────────────────────────────────────────────────────────────────────────
 */
...
import scijava.roi.types.PolylinePoints3D;
import scijava.roi.measurement.Area;
import scijava.roi.measurement.Length;
import scijava.roi.shape.PhysicalShape;
import scijava.roi.types.Vertex3D;

public class Polyline implements PhysicalShape, Length, Area
{
  /*
  ...
  PolylinePoints3D rep_canonical;
